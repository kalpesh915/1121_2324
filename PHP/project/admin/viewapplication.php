<?php
    ...
    if(isset($_GET["careerid"])){
        ...
        $result = $career->getOneApplication($careerid);
        
        $row = $result->fetch_assoc();
        extract($row);

        $career->markReadApplication($careerid);
    }else{
                                     ...
                                     <div class="table-responsive">
                                        <table class="table table-hover table-striped">
                                            <tr>
                                                ...
                                                <td><?= $candidatefname; ?></td>
                                            </tr>

                                            <tr>
                                                <th>Candidate Last Name</th>
                                                <td><?= $candidatelname; ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th>Candidate Cover Latter</th>
                                                <td><?= $coverlatter; ?></td>
                                            </tr>

                                            <tr>
                                                <th colspan="2">
                                                    <object data="<?= $resumepath; ?>" class="w-100" style="height:700px;"></object>
                                                </th>
                                            </tr>
                                        </table>
                                     </div>
