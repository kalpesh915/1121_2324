<?php
    /*
        ...
        First, we will look at the following two functions: json_encode(), json_decode()

        PHP - json_encode() : The json_encode() function is used to encode a value to JSON format.
    */ 

    $student = ["roll" => 1, "fname" => "Meet", "lname" => "Sinojiya", "city" => "Rajkot", "married" => false, "phone" => "9955885544"];
